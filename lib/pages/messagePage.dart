...
import 'package:ume_connect/models/favcontactdata.dart';
import 'package:ume_connect/pages/chat.dart';
import 'package:ume_connect/pages/userList.dart';

import 'package:ume_connect/widgets/avatar.dart';
import 'package:ume_connect/widgets/errorMessage.dart';
import 'package:ume_connect/widgets/unreadIndicator.dart';
...
abstract class Helpers {
  ...
  static String? getChannelUID(Channel channel, User currentUser) {
    if (channel.id != null) {
      return channel.id!;
    } else if (channel.state?.members.isNotEmpty ?? false) {
      final otherMembers = channel.state?.members
